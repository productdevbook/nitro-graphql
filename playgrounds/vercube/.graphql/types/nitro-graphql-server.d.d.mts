...
import { GraphQLContext } from "../../src/types/graphql-context.mjs";
export interface NPMConfig {
	framework: "graphql-yoga";
}
type Primitive = null | undefined | string | number | boolean | symbol | bigint;
type BuiltIns = Primitive | void | Date | RegExp;
type ResolverReturnType<T> = T extends BuiltIns ? T : T extends (...args: any[]) => unknown ? T | undefined : T extends object ? T extends Array<infer ItemType> ? ItemType[] extends T ? Array<ResolverReturnType<ItemType>> : ResolverReturnTypeObject<T> : ResolverReturnTypeObject<T> : unknown;
...
export type SubscriptionResolver<
	...
	TContext = Record<PropertyKey, never>,
	TArgs = Record<PropertyKey, never>
> = ((...args: any[]) => SubscriptionObject<TResult, TKey, TParent, TContext, TArgs>) | SubscriptionObject<TResult, TKey, TParent, TContext, TArgs>;
